...
//////////////thread control
reg [1:0] global_thread_id;
always @(posedge clk) begin
    if (rst) 
        global_thread_id <= 2'b00;
    else     
        global_thread_id <= global_thread_id + 2'b01;
end
...
IF_stage u_if(
	...
	//thread
	.ctrl_thread(global_thread_id),
    .branch_id_thread(branch_id_thread),
	.o_ctrl_thread(if_thread_id)
);
...
wire [1:0]  id_thread_id;///from if 2 id
ifid_reg u_ifid(
    .clk(clk),
    .rst(rst),
	///thread
	.i_thread(if_thread_id),
    .o_thread(id_thread_id),
...
wire [3:0]  wb_waddr;
wire        wb_wen;
wire [1:0]  wb_thread_id_out;///from wb 2 id 
ID u_id(
    .clk(clk),
    .rst(rst),
    .i_inst(id_inst),
	...
	//////thread
	.id_thread(id_thread_id),
	.wb_thread(wb_thread_id_out),
	.branch_id_thread(branch_id_thread),
	///////
    .o_WReg1(id_WReg1),
    .o_WRegEn(id_WRegEn),
...
idex_reg u_idex(
	...
	////thread
	.i_wb_thread(id_thread_id),
    .o_wb_thread(ex_thread_id),
	///
...
EX_stage u_ex(
	...
	//thread
	.i_wb_thread(ex_thread_id),
    .o_wb_thread(mem_thread_id));
...
data_mem u_mem(
	...
	///thread
	.i_wb_thread(mem_thread_id),
    .o_wb_thread(wb_thread_id_in),
...
WB u_wb(
	...
	.i_wb_thread(wb_thread_id_in),
    .o_wb_thread(wb_thread_id_out));
