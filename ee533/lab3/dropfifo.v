...
// /___/   /\     Timestamp : 01/31/2026 00:03:20
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/student/isetest/lab37/dropfifo.sch" dropfifo.vf
...
module dropfifo(clk, 
   ...
   COMP8_MXILINX_dropfifo XLXI_3 (.A(XLXN_15[7:0]), 
                                  .B(XLXN_19[7:0]), 
                                  .EQ(XLXN_18));
   // synthesis attribute HU_SET of XLXI_3 is "XLXI_3_17"
   COMP8_MXILINX_dropfifo XLXI_4 (.A(XLXN_19[7:0]), 
                                  .B(XLXN_16[7:0]), 
                                  .EQ(XLXN_21));
   // synthesis attribute HU_SET of XLXI_4 is "XLXI_4_18"
   FDC XLXI_5 (.C(XLXN_36), 
               .CLR(rst), 
               .D(XLXN_22), 
               .Q(valid_data));
   defparam XLXI_5.INIT = 1'b0;
   CB8CE_MXILINX_dropfifo XLXI_6 (.C(XLXN_36), 
                                  .CE(XLXN_22), 
                                  .CLR(rst), 
                                  .CEO(), 
                                  .Q(XLXN_24[7:0]), 
   ...
   OR2 XLXI_10 (.I0(XLXN_12), 
                .I1(XLXN_11), 
                .O(XLXN_9));
   AND2B1 XLXI_11 (.I0(XLXN_25), 
                   .I1(XLXN_9), 
                   .O(XLXN_27));
   FD XLXI_12 (.C(XLXN_36), 
               .D(fifowrite), 
               .Q(XLXN_38[0]));
   ...
   CB8CLE_MXILINX_dropfifo XLXI_14 (.C(XLXN_36), 
                                    .CE(XLXN_38[0]), 
                                    .CLR(rst), 
                                    .D(XLXN_16[7:0]), 
                                    .L(XLXN_25), 
   ...
   dual9Bmem XLXI_19 (.addra(XLXN_15[7:0]), 
                      .addrb(XLXN_24[7:0]), 
                      .clka(XLXN_36), 
                      .clkb(XLXN_36), 
                      .dina(XLXN_26[71:0]), 
